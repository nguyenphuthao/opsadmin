                    ...
                    <ul class="list divider-full-bleed">
                      <li class="tile">
                        <div class="tile-content">
                          <div class="tile-icon">
                            <img src="{{asset('admin/assets/img/avatar9.jpg')}}" alt="" />
                          </div>
                      ...
                      <li class="tile">
                        <div class="tile-content">
                          <div class="tile-icon">
                            <img src="{{asset('admin/assets/img/avatar4.jpg')}}" alt="" />
                          </div>
                      ...
                      <li class="tile">
                        <div class="tile-content">
                          <div class="tile-icon">
                            <img src="{{asset('admin/assets/img/avatar11.jpg')}}" alt="" />
                          </div>
                      ...
                      <li class="tile">
                        <div class="tile-content">
                          <div class="tile-icon">
                            <img src="{{asset('admin/assets/img/avatar7.jpg')}}" alt="" />
                          </div>
                      ...
                      <li class="tile">
                        <div class="tile-content">
                          <div class="tile-icon">
                            <img src="{{asset('admin/assets/img/avatar8.jpg')}}" alt="" />
                          </div>
                      ...
                      <li class="tile">
                        <div class="tile-content">
                          <div class="tile-icon">
                            <img src="{{asset('admin/assets/img/avatar2.jpg')}}" alt="" />
                          </div>
...
@endsection
@section('script')
<script src="{{asset('admin/assets/js/libs/moment/moment.min.js')}}"></script>
<script src="{{asset('admin/assets/js/libs/flot/jquery.flot.min.js')}}"></script>
<script src="{{asset('admin/assets/js/libs/flot/jquery.flot.time.min.js')}}"></script>
<script src="{{asset('admin/assets/js/libs/flot/jquery.flot.resize.min.js')}}"></script>
<script src="{{asset('admin/assets/js/libs/flot/jquery.flot.orderBars.js')}}"></script>
<script src="{{asset('admin/assets/js/libs/flot/jquery.flot.pie.js')}}"></script>
<script src="{{asset('admin/assets/js/libs/flot/curvedLines.js')}}"></script>
<script src="{{asset('admin/assets/js/libs/jquery-knob/jquery.knob.min.js')}}"></script>
<script src="{{asset('admin/assets/js/libs/sparkline/jquery.sparkline.min.js')}}"></script>
<script src="{{asset('admin/assets/js/libs/d3/d3.min.js')}}"></script>
<script src="{{asset('admin/assets/js/libs/d3/d3.v3.js')}}"></script>
<script src="{{asset('admin/assets/js/libs/rickshaw/rickshaw.min.js')}}"></script>
<script src="{{asset('admin/assets/js/core/demo/DemoDashboard.js')}}"></script>
@endsection
