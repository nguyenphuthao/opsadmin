        ...
        <div class="card card-bordered section-body ">
            ...
            <div class="card-head">
                ...
                <ul class="nav nav-tabs pull-left">
                    <li class="active"><a href="javascript:;" style='line-height: 36px;'>TÀI KHOẢN</a></li>
                    <li><a href="{{PATH_URL}}admincp/users/listvideo" style='line-height: 36px;'>CLIP</a></li>
                </ul>
                <div class="tools">
                    <div class="btn-group">
            ...
            <div class="card-body style-default-bright">
                <div class="table-responsive">
                    <div id="datatable1_wrapper" class="dataTables_wrapper no-footer">
                        ...
                        <div id="loadContent" class='pull-left col-md-12'></div>
                    </div>
                </div>
            </div><!--end .card-body -->
        </div>
