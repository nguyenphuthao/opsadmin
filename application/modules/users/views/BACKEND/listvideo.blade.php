...
<div id="content">
    <section>
        <div class="card card-bordered section-body ">
            ...
            <div class="card-head">
                <header class='pull-left'><i class="fa fa-fw fa-tag"></i> DANH SÁCH </header>
                <ul class="nav nav-tabs pull-left">
                    <li class=""><a href="{{PATH_URL}}admincp/users/" style='line-height: 36px;'>TÀI KHOẢN</a></li>
                    <li class='active'><a href="javascript:;" style='line-height: 36px;'>CLIP</a></li>
                </ul>
                <div class="tools">
                    <div class="btn-group">
            ...
            <div class="card-body style-default-bright">
                <div class="table-responsive">
                    <div id="datatable1_wrapper" class="dataTables_wrapper no-footer">
                        ...
                        <div id="loadContent" class='col-md-12 pull-left'></div>
                    </div>
                </div>
            </div><!--end .card-body -->
        </div>
...
<script type="text/javascript" charset="utf-8">
    ...
    function searchContentType(d, b) {
        ...
        $("#start").val(d);
        $.post(root + "admincp/" + module + "/ajaxLoadVideo", {
            func_order_by : a,
            order_by : c,
            start : d,
            first_access : fa,
